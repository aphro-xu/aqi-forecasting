...
def calcAQI(C, mold, standard='cn'):
    ...
    if mold == 'pm2.5':
        ...
        # index_cn = [0, 2, 4, 14, 24, 36, 48, 60]    # 24 hours
        index_cn = [0, 5, 10, 35, 60, 90, 120, 150]  # 1 hour
        index_us = [0, 4.4, 9.4, 12.4, 15.4, 30.4, 40.4, 50.4]
    elif mold == 'SO2':
        # index_cn = [0, 50, 150, 475, 800, 1600, 2100, 2620]     # 24 hours
        index_cn = [0, 150, 500, 650, 800, 1600, 2100, 2620]     # 1 hour
        index_us = [0, 35, 75, 185, 304, 604, 804, 1004]
    elif mold == 'NO2':
        # index_cn = [0, 40, 80, 180, 280, 565, 750, 940]    # 24 hours
        index_cn = [0, 100, 200, 700, 1200, 2340, 3090, 3840]   # 1 hour
        index_us = [0, 53, 100, 360, 649, 1249, 1649, 2049]
    elif mold == 'O3':
        # index_cn = [0, 100, 160, 215, 265, 800, 1000, 1000]  # 8 hours
        index_cn = [0, 160, 200, 300, 400, 800, 1000, 1200]     # 1 hour
        # index_us = [0, 54, 70, 85, 105, 200]     # 8 hours
        index_us = [0, 0, 124, 164, 204, 404, 504, 604]     # 1 hour
    else:
        return 'Unknown'
...
def AQILevel(aqi):
    ...
    level = {50: 'Good', 100: 'Moderate', 150: 'Unhealthy for Sensitive Groups', 200: 'Unhealthy',
             300: 'Very Unhealthy', 400: 'Hazardous', 500: 'Hazardous', 501: 'Overflow'}
